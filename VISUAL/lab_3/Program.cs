...
namespace Example
{
    class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine("12 + 230 = 242 : CCXLII : " + (Obj1 + Obj2).ToString());
            Console.WriteLine("1560 - 230 = 1330 : MCCCXXX : " + (Obj3 - Obj2).ToString());
            Console.WriteLine("12 * 230 = 2760 : MMDCCLX : " + (Obj1 * Obj2).ToString());
            Console.WriteLine("1560 / 12 = 130 : CXXX : " + (Obj3 / Obj1).ToString());
